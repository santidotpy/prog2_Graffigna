import paquete3.Empleado;
import paquete3.ListaGenerica;
...
public class App {
    ...
    public void ejecutar() {
        ...
        // listaEmpleados.addToList(new Empleado("Jess", "Thomas", 444, 4));
        ...
        System.out.println("Ultimo empleado: " + ultimoEmpleado.getApellido() + ", " + ultimoEmpleado.getNombre());
    }
}
